...
class DailyTimelineScreen extends StatefulWidget {
  ...
  const DailyTimelineScreen({super.key, this.priority, required this.title});
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: priorityColor, width: 0),
                  ),
                  child: Center(
                    child: Icon(
                      _getTaskIcon(task),
          ...
          Expanded(
            child: Container(
              margin: const EdgeInsets.only(
                top: 0,
              ), // 상단 마진 제거하여 타임라인 아이콘과 일정 카드 정확히 중앙 정렬
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
                color: Colors.white,
