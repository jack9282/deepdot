class AlarmIdGenerator {
  // ID 범위 정의:
  // 1000-1999: 복용 알람
  // 2000-2999: 루틴 알람 (baseId)
  // 20000-29999: 루틴 주간 알람 (baseId * 10 + weekday)
  // 3000-3999: 스케줄 알람 (baseId)
  // 30000-39999: 스케줄 시간별 알람 (baseId * 10 + offset)
  
  static int _takingCounter = 1000;
  static int _routineCounter = 2000;
  static int _scheduleCounter = 3000;

  /// 약물 복용 알람을 위한 ID를 생성합니다. (1000-1999)
  ...
  /// 스케줄 알람을 위한 ID를 생성합니다. (3000-3999)
